  ...
  ({ children, onClick, className = "", type = "button", ...props }, ref) => {
    return (
      <button
        ...
        type={type}
        onClick={onClick}
        className={`px-4 py-4 rounded-[30px] border-[1.5px] border-black bg-black text-white relative overflow-hidden group text-2xl leading-6 font-medium font-['Neue_Augenblick'] transition-all duration-500 hover:!border-0 hover:!px-[calc(1rem+1.5px)] hover:!py-[calc(1rem+1.5px)] ${className}`}
        {...props}
      >
